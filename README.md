...
> :warning: This integration is deprecated and is removed in Home Assistant Core 2022.4.
>
...
>
> This custom component will also not be maintained and should only be used to give yourself more time to switch to a proper solution.
> Put the `orangepi_gpio` folder in your `custom_components` folder of your Home Assistant installation to use it.
